...
def line_detection(image):
    ...
    bw = cv2.adaptiveThreshold(image, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY, 15, 1)
    ...
    # cv2.imshow("horizontal github",horizontal)
    # cv2.waitKey(0)
    ...
    # cv2.imshow("vertical github",vertical)
    # cv2.waitKey(0)
    #####################################################
